...
namespace TNAUPMS.WebApi
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      ConfigurationRoot = TNAUPMS.Startup.GetConfigurationRoot(services);

      // ===== Add DbContext ========
      services.AddDbContext<TNAUPMSDbContext>(options =>
      {
      ...
      TNAUPMS.Startup.ConfigureDomainServices(services);
      TNAUPMS.Domains.Startup.ConfigureRepositoryServices(services);
      ...
      services.AddIdentity<ConfigUser, Role>()
          .AddEntityFrameworkStores<TNAUPMSDbContext>()
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env, TNAUPMSDbContext dbContext)
    {
