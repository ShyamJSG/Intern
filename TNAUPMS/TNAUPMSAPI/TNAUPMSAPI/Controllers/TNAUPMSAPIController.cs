using TNAUPMS.Controllers;
using TNAUPMS.Domains.Models;
using TNAUPMS.Domains.Repositories;
...
{
    public abstract class TNAUPMSApiController<TModel, TRepository> : TNAUPMS.Controllers.Controller
        where TModel : Model
