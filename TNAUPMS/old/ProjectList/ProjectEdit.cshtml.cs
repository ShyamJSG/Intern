...
{
    public class ProjectEdit : PageModel
    {
        [BindProperty]
        ...
        public ProjectEdit(HttpClient client, IConfiguration iConfig)
        {
            _client = client;
        ...
        public async Task<IActionResult> OnGet(int ProjectId)
        {
            ...
            var responsepro = await _client.GetAsync(baseurl + "/project/get-project-byid/" + ProjectId.ToString());
