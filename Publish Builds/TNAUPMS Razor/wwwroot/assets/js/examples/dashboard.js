...
$(document).ready(function () {
    ...
    //            type: 'bar',
    //            data: {
    //                labels: ["Central Government", "State Government", "University", "PF"],
    //                datasets: [
    //                    {
        ...
        if ($('#chart_demo_7').length) {
            ...
            new Chart(ctx, {
                ...
                data: {
                    datasets: [{
                        data: [38, 40, 107],
                        backgroundColor: ['#399918', '#FF7777', '#FFDE4D'],
                        label: 'Project Status'
                    }],
                    labels: [
                        'Projects Completed',
                        'Projects yet to be completed this Year',
                        'Proposed Project',
                    ]
                },
                options: {
    ...
    function chart_demo_4() {
        if ($('#chart_demo_4').length) {
            ...
            var densityData = {
                backgroundColor: ['#E4F9F5', '#30E3CA', '#11999E'],
                data: [ 80, 40, 59]
            };
            new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: [">6 Article", "<6 Article", "Book Article"],
                    datasets: [densityData]
                },
                options: {
                    scaleFontColor: "#FFFFFF",
    ...
    function chart_demo_2() {
        if ($('#chart_demo_2').length) {
            ...
            new Chart(ctx, {
                type: 'pie',
                data: {
                    labels: ["Greater than 2", "Zero Articles", "Equal to 1"],
                    datasets: [{
                        label: "Rainfall",
